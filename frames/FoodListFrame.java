...
public class FoodListFrame extends JFrame implements ActionListener
{
	...
	public FoodListFrame(User u)
	{
		...
		this.confirmBtn=new JButton("Order");
		this.confirmBtn.setBounds(480,500,100,30);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		{
			JOptionPane.showMessageDialog(this,"Order Id: 003-A");
		}
	}
}